...
export class DataTests {
  ...
  public static readonly avaliacoes: Avaliacao[] = [
    ...
    new Avaliacao(5, 'Odiei, baixo custo benefício, espaçoso',
      ...
      2, new Date(new Date().setFullYear(2019, 12, 11))
    ),
    new Avaliacao(4, 'É, não é aquelas coisas',
      // tslint:disable-next-line:max-line-length
  ...
  public static readonly categorias: Categoria[] = [
  ...
  public static readonly enderecos: Endereco[] = [
  ...
  public static readonly lojasParceiras: Loja[] = [
    new Loja(
  ...
  public static readonly opcoesEntrega: DeliveryOption[] = [
    {cost: 14.25, time: 12},
    {cost: DataTests.obterPrecoRandom(), time: 14},
    {cost: DataTests.obterPrecoRandom(), time: 5}
  ];
  ...
  private static productRandom(title: string, desc: string, imgUrl: string): Produto {
    return new Produto(
      ...
      [DataTests.categorias[randomInt(0, DataTests.categorias.length - 1)]],
